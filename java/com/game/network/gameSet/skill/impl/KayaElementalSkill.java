...
@Component
@Character(name = "凯亚")
public class KayaElementalSkill implements SkillStrategy{
    private static final Skill.SkillType TYPE = Skill.SkillType.ELEMENTAL_SKILL;
    private static final String NAME = "霜袭";
    ...
    public List<DiceCost> getDiceCosts() {
        DiceCost diceCost = new DiceCost(3, "冰");
    ...
    public List<SkillEffect> getEffects() {
        ElementAttachEffect skillEffect = new ElementAttachEffect("冰");
